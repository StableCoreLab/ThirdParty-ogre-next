...
if (WIN32)
  ...
  set(OGRE_INSTALL_RUNTIME_ROOT "Bin/${OGRE_BUILD_PLATFORM_DIR}")
  set(OGRE_INSTALL_LIBRARY_ROOT "Lib/${OGRE_BUILD_PLATFORM_DIR}")
elseif (UNIX)
  ...
  set(OGRE_INSTALL_RUNTIME_ROOT "bin")
  set(OGRE_INSTALL_LIBRARY_ROOT "${OGRE_LIB_DIRECTORY}")
endif ()
...
function(ogre_install_target TARGETNAME SUFFIX EXPORT)
	...
	if(EXPORT)
	  install(TARGETS ${TARGETNAME} #EXPORT Ogre-exports
		BUNDLE DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELEASE_PATH}" CONFIGURATIONS Release None ""
		RUNTIME DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELEASE_PATH}" CONFIGURATIONS Release None ""
		LIBRARY DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_RELEASE_PATH}${SUFFIX}" CONFIGURATIONS Release None ""
		ARCHIVE DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_RELEASE_PATH}${SUFFIX}" CONFIGURATIONS Release None ""
		FRAMEWORK DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_RELEASE_PATH}/Release" CONFIGURATIONS Release None ""
      )
	  install(TARGETS ${TARGETNAME} #EXPORT Ogre-exports
		BUNDLE DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELWDBG_PATH}" CONFIGURATIONS RelWithDebInfo
		RUNTIME DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELWDBG_PATH}" CONFIGURATIONS RelWithDebInfo
		LIBRARY DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_RELWDBG_PATH}${SUFFIX}" CONFIGURATIONS RelWithDebInfo
		ARCHIVE DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_RELWDBG_PATH}${SUFFIX}" CONFIGURATIONS RelWithDebInfo
		FRAMEWORK DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_RELWDBG_PATH}/RelWithDebInfo" CONFIGURATIONS RelWithDebInfo
      )
	  install(TARGETS ${TARGETNAME} #EXPORT Ogre-exports
		BUNDLE DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_MINSIZE_PATH}" CONFIGURATIONS MinSizeRel
		RUNTIME DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_MINSIZE_PATH}" CONFIGURATIONS MinSizeRel
		LIBRARY DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_MINSIZE_PATH}${SUFFIX}" CONFIGURATIONS MinSizeRel
		ARCHIVE DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_MINSIZE_PATH}${SUFFIX}" CONFIGURATIONS MinSizeRel
		FRAMEWORK DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_MINSIZE_PATH}/MinSizeRel" CONFIGURATIONS MinSizeRel
      )
	  install(TARGETS ${TARGETNAME} #EXPORT Ogre-exports
		BUNDLE DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_DEBUG_PATH}" CONFIGURATIONS Debug
		RUNTIME DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_DEBUG_PATH}" CONFIGURATIONS Debug
		LIBRARY DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_DEBUG_PATH}${SUFFIX}" CONFIGURATIONS Debug
		ARCHIVE DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_LIB_DEBUG_PATH}${SUFFIX}" CONFIGURATIONS Debug
		FRAMEWORK DESTINATION "${OGRE_INSTALL_LIBRARY_ROOT}${OGRE_DEBUG_PATH}/Debug" CONFIGURATIONS Debug
	  )
...
function(ogre_config_lib LIBNAME EXPORT)
  ...
  if (OGRE_INSTALL_PDB)
	...
	if (NOT OGRE_STATIC)
	  install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_DEBUG_PATH}/${LIBNAME}_d.pdb
	    DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_DEBUG_PATH}"
		CONFIGURATIONS Debug
	  )
	  install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_RELWDBG_PATH}/${LIBNAME}.pdb
	    DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELWDBG_PATH}"
...
function(ogre_config_plugin PLUGINNAME)
  ...
  if (OGRE_INSTALL_PDB)
	...
	# Static libs don't have PDBs
	if (NOT OGRE_STATIC)
	  install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_DEBUG_PATH}/${PLUGINNAME}_d.pdb
	    DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_DEBUG_PATH}"
		CONFIGURATIONS Debug
	  )
	  install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_RELWDBG_PATH}/${PLUGINNAME}.pdb
	    DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELWDBG_PATH}"
		CONFIGURATIONS RelWithDebInfo
	  )
	endif ()
...
function(ogre_config_sample_exe SAMPLENAME)
  ...
  if (OGRE_INSTALL_PDB AND OGRE_INSTALL_SAMPLES)
	  ...
	  install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_DEBUG_PATH}/${SAMPLENAME}.pdb
		  DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_DEBUG_PATH}"
		  CONFIGURATIONS Debug
		  )
	  install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_RELWDBG_PATH}/${SAMPLENAME}.pdb
		  DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELWDBG_PATH}"
		  CONFIGURATIONS RelWithDebInfo
		  )
  endif ()
...
function(ogre_config_tool TOOLNAME)
  ...
  if (OGRE_INSTALL_TOOLS)
    ...
    if (OGRE_INSTALL_PDB)
      # install debug pdb files
      install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_DEBUG_PATH}/${TOOLNAME}_d.pdb
        DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_DEBUG_PATH}"
        CONFIGURATIONS Debug
        )
      install(FILES ${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}${OGRE_RELWDBG_PATH}/${TOOLNAME}.pdb
        DESTINATION "${OGRE_INSTALL_RUNTIME_ROOT}${OGRE_RELWDBG_PATH}"
        CONFIGURATIONS RelWithDebInfo
        )
    endif ()
