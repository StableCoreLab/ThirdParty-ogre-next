...
if (CMAKE_VS_PLATFORM_NAME)
  set(OGRE_BUILD_PLATFORM_DIR "${CMAKE_VS_PLATFORM_NAME}")
elseif (CMAKE_GENERATOR_PLATFORM)
  set(OGRE_BUILD_PLATFORM_DIR "${CMAKE_GENERATOR_PLATFORM}")
else()
  set(OGRE_BUILD_PLATFORM_DIR "${CMAKE_SYSTEM_PROCESSOR}")
endif()

set(OGRE_OUTPUT_ROOT "${OGRE_SOURCE_DIR}/..")
...
if (NOT OGRE_ARCHIVE_OUTPUT)
  if(APPLE AND NOT OGRE_BUILD_PLATFORM_ANDROID)
    ...
    set(OGRE_ARCHIVE_OUTPUT ${OGRE_OUTPUT_ROOT}/bin)
  endif()
endif ()
if (NOT OGRE_LIBRARY_OUTPUT)
  if(APPLE AND NOT OGRE_BUILD_PLATFORM_ANDROID)
    ...
    set(OGRE_LIBRARY_OUTPUT ${OGRE_OUTPUT_ROOT}/bin)
  endif()
endif ()
if (NOT OGRE_RUNTIME_OUTPUT)
  set(OGRE_RUNTIME_OUTPUT ${OGRE_OUTPUT_ROOT}/bin)
endif ()
...
function(ogre_config_common TARGETNAME)
  set_target_properties(${TARGETNAME} PROPERTIES
    ...
    ARCHIVE_OUTPUT_DIRECTORY_DEBUG "${OGRE_ARCHIVE_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/Debug"
    ARCHIVE_OUTPUT_DIRECTORY_RELEASE "${OGRE_ARCHIVE_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/Release"
    ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OGRE_ARCHIVE_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/RelWithDebInfo"
    ARCHIVE_OUTPUT_DIRECTORY_MINSIZEREL "${OGRE_ARCHIVE_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/MinSizeRel"
    LIBRARY_OUTPUT_DIRECTORY_DEBUG "${OGRE_LIBRARY_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/Debug"
    LIBRARY_OUTPUT_DIRECTORY_RELEASE "${OGRE_LIBRARY_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/Release"
    LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OGRE_LIBRARY_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/RelWithDebInfo"
    LIBRARY_OUTPUT_DIRECTORY_MINSIZEREL "${OGRE_LIBRARY_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/MinSizeRel"
    RUNTIME_OUTPUT_DIRECTORY_DEBUG "${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/Debug"
    RUNTIME_OUTPUT_DIRECTORY_RELEASE "${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/Release"
    RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/RelWithDebInfo"
    RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${OGRE_RUNTIME_OUTPUT}/${OGRE_BUILD_PLATFORM_DIR}/MinSizeRel"
  )
